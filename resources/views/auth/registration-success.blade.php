        ...
        <div class="max-w-2xl w-full text-center">
            ...
            <div class="mb-8">
                <a href="{{ config('app.webapp_url', 'http://localhost:5173') }}/login" 
                   class="inline-flex items-center justify-center px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white text-lg font-semibold rounded-lg transition-colors shadow-lg hover:shadow-xl dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100">
