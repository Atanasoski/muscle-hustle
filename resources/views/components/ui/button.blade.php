...
@php
    ...
    // Variant map
    $variantMap = [
        'primary' => 'bg-gray-900 text-white shadow-theme-xs hover:bg-gray-800 disabled:opacity-50 disabled:bg-gray-400 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 dark:disabled:bg-gray-500 dark:disabled:text-gray-300',
