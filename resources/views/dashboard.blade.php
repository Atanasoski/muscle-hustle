            ...
            <div class="card h-100 border-0 shadow-sm hover-lift">
                ...
                <div class="card-body p-4">
                    <div class="d-grid gap-3">
                        <a href="{{ route('workout-templates.create') }}" class="btn btn-action btn-outline-primary btn-lg text-start">
                            <div class="d-flex align-items-center">
                                <div class="action-icon bg-primary bg-opacity-10 text-primary me-3">
                                    <i class="bi bi-plus-circle-fill"></i>
                                </div>
                                <div>
                                    <div class="fw-bold">New Template</div>
                                    <small class="text-muted">Create a workout template</small>
                                </div>
                            </div>
                        </a>
                        
                        <a href="{{ route('planner.workouts') }}" class="btn btn-action btn-outline-warning btn-lg text-start">
                            <div class="d-flex align-items-center">
                                <div class="action-icon bg-warning bg-opacity-10 text-warning me-3">
                                    <i class="bi bi-calendar-week-fill"></i>
                                </div>
                                <div>
                                    <div class="fw-bold">Plan Workouts</div>
                                    <small class="text-muted">Schedule your week</small>
                                </div>
                            </div>
                        </a>
                        
                        <a href="{{ route('planner.meals') }}" class="btn btn-action btn-outline-success btn-lg text-start">
                            <div class="d-flex align-items-center">
                                <div class="action-icon bg-success bg-opacity-10 text-success me-3">
                                    <i class="bi bi-egg-fried"></i>
                                </div>
                                <div>
                                    <div class="fw-bold">Plan Meals</div>
                                    <small class="text-muted">Nutrition planning</small>
                                </div>
                            </div>
                        </a>
                        
                        <a href="{{ route('workout-templates.index') }}" class="btn btn-action btn-outline-info btn-lg text-start">
                            <div class="d-flex align-items-center">
                                <div class="action-icon bg-info bg-opacity-10 text-info me-3">
                                    <i class="bi bi-journal-text"></i>
                                </div>
                                <div>
                                    <div class="fw-bold">My Templates</div>
                                    <small class="text-muted">View all templates</small>
                                </div>
                            </div>
                        </a>
                    </div>
