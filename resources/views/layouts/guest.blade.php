...
<head>
    ...
    <title>{{ $title ?? 'Authentication' }} | {{ config('app.name', 'Fit Nation') }}</title>
...
<body x-data="{ 'loaded': true }">
    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="bg-orange-300 relative hidden h-full w-full items-center lg:grid lg:w-1/2 ">
                    ...
                    <div class="flex max-w-md flex-col items-center space-y-8 px-6">
                        ...
                        {{-- <div class="text-center space-y-3">
                            <h1 class="text-5xl font-bold tracking-tight leading-tight">
                                <span class="text-white">Fit Nation</span>
                            </h1>
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button
                    class="bg-orange-500 hover:bg-orange-600 inline-flex size-14 items-center justify-center rounded-full text-white transition-colors"
